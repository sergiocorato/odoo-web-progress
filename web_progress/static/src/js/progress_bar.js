...
odoo.define("web.progress.bar", function (require) {
    ...
    var ProgressBar = Widget.extend({
        ...
        showProgress: function (progress_list) {
            ...
            if (
                this.progress_code !== progress_code ||
                (!is_system && uid !== top_progress.uid)
            ) {
                return;
            }
            ...
            self.$progress_bar
                .stop(true, true)
                .animate({width: progress + "%"}, animation_timeout, "linear");
        ...
        _confirmCancel: function () {
            ...
            var $progress_cancel_confirm_no = self.$progress_cancel.find(
                "#progress_cancel_no"
            );
        ...
        _normalCancel: function () {
            ...
            var $progress_cancel_confirm = self.$progress_cancel.find(
                "#progress_cancel_confirm"
            );
